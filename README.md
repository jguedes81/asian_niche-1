...
The GitHub repository for this project does not contain the output generated by the script---3.23 GB. All output data is available as a separate Zenodo archive at
