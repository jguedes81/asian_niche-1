prepare_marcott <- function(calibration.years){
  ...
  dir.create("./OUTPUT/DATA/mann2008/", showWarnings = FALSE, recursive = TRUE)
  FedData::download_data(url="ftp://ftp.ncdc.noaa.gov/pub/data/paleo/contributions_by_author/mann2008/instrument.zip",destdir="./OUTPUT/DATA/mann2008/")
  unzip("./OUTPUT/DATA/mann2008/instrument.zip", exdir="./OUTPUT/DATA/mann2008/")
  # Get just the Northern Hemisphere HAD CRU V3 data.
  iHAD_NH_reform <- readr::read_table("./OUTPUT/DATA/mann2008/iHAD_NH_reform", col_names = c("Year","Temperature"))
  ...
  dir.create("./OUTPUT/DATA/marcott2013/", showWarnings = FALSE, recursive = TRUE)
  FedData::download_data(url="http://www.sciencemag.org/content/suppl/2013/03/07/339.6124.1198.DC1/Marcott.SM.database.S1.xlsx",destdir="./OUTPUT/DATA/marcott2013/")
  marcott2013 <- readxl::read_excel("./OUTPUT/DATA/marcott2013/Marcott.SM.database.S1.xlsx", sheet="TEMPERATURE STACKS", skip=6, col_names=F)[,20:22]
  ...
  readr::write_csv(marcott2013,"./OUTPUT/MARCOTT2013_Z.csv")
  return(marcott2013)
}
